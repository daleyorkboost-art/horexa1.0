...
export default function PortalTicketsPage() {
  return (
    <PortalShell activeHref="/portal/tickets" title="Support Tickets" description="Submit support requests, track replies, and manage service issues.">
      <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
        <PortalPanel title="Create Ticket" description="Static form now, designed for later ticket API integration.">
          <form className="flex flex-col gap-4">
            <div className="flex flex-col gap-2">
              <Label htmlFor="ticket-subject">Subject</Label>
              <Input id="ticket-subject" placeholder="What do you need help with?" />
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <Textarea id="ticket-message" placeholder="Describe the issue or request." />
            </div>
            <Button type="submit"><MessageSquarePlus data-icon="inline-start" /> Submit Ticket</Button>
          </form>
        </PortalPanel>
        <PortalPanel title="Support SLA" description="Premium AMC clients receive priority response for safety and service continuity issues." action="WhatsApp Support">
